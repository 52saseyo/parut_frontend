...
function AuthPage() {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-emerald-50 px-5 py-8 sm:py-12">
      <div className="flex w-full max-w-md flex-col overflow-hidden rounded-3xl bg-white shadow-xl shadow-emerald-900/5">
        <div
          className="order-first h-36 bg-contain bg-center bg-no-repeat bg-emerald-50"
          style={{ backgroundImage: "url('/images/parut.png')" }}
          role="img"
