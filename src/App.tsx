  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-emerald-50 px-5 py-8 sm:py-12">
      <div className="grid w-full max-w-5xl overflow-hidden rounded-3xl bg-white shadow-xl shadow-emerald-900/5 lg:grid-cols-[1fr_0.8fr]">
        <div
          className="order-first h-36 bg-center bg-no-repeat bg-emerald-50 lg:order-last lg:h-auto lg:min-h-[620px]"
          style={{ backgroundImage: "url('/images/parut.png')", backgroundSize: '100% 100%' }}
          role="img"
...
function SellerLoginPage() {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-emerald-50 px-5 py-8 sm:py-12">
      <div className="grid w-full max-w-5xl overflow-hidden rounded-3xl bg-white shadow-xl shadow-emerald-900/5 lg:grid-cols-[1fr_0.8fr]">
        <div
          className="order-first h-36 bg-center bg-no-repeat bg-emerald-50 lg:order-last lg:h-auto lg:min-h-[560px]"
          style={{ backgroundImage: "url('/images/parut.png')", backgroundSize: '100% 100%' }}
          role="img"
